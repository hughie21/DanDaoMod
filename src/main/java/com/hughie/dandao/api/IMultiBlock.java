...
// CREDIT GOES TO: TartaricAcid | https://github.com/TartaricAcid/TouhouLittleMaid/blob/1.20/src/main/java/com/github/tartaricacid/touhoulittlemaid/api/block/IMultiBlock.java
public interface IMultiBlock {
    ...
    void reset(Level level, BlockPos pos);
}
