...
public class MortarMenu extends AbstractContainerMenu {
    public final MortarBlockEntity mortarBlockEntity;
    ...
    public MortarMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        mortarBlockEntity = ((MortarBlockEntity) entity);
        ...
        this.mortarBlockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, mortarBlockEntity.getBlockPos()),
